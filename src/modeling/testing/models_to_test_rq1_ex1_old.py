...
def model_list_rq1_ex1(data):
    ...
    train_loader_gnn_model_simple_framework_without_front_flex_only_degree = NeighborLoader(
        data_only_degree,
        shuffle=True,
    ...
    val_loader_gnn_model_simple_framework_without_front_flex_only_degree = NeighborLoader(
        data_only_degree,
        shuffle=True,
        num_neighbors=[5, 5, 10],
        batch_size=64,
    ...
    test_loader_gnn_model_simple_framework_without_front_flex_only_degree = NeighborLoader(
        data_only_degree,
        shuffle=True,
        num_neighbors=[5, 5, 10],
        batch_size=64,
    ...
    gnn_model_downstream_simple_framework_only_degree = GraphSAGE(
        ...
        num_layers=2,
        out_channels=256,
        dropout=0.29735043999261035,
        act='leaky_relu',
        aggr='max',
        norm=LayerNorm(256)
    )

    layer_sizes = [32 + 256] + [128] * 4 + [2]
    mlp_only_degree = build_mlp(layer_sizes, nn.ReLU, 0.2558110081374124)

    gnn_model_simple_framework_without_front_flex_only_degree = DGIAndGNN(dgi_model_simple_framework_only_degree,
                                                              gnn_model_downstream_simple_framework_only_degree, mlp_only_degree, False)
    optimizer_gnn_simple_framework_without_front_flex_only_degree = torch.optim.Adam(
        gnn_model_simple_framework_without_front_flex_only_degree.parameters(),
        lr=0.0005033314558303147, weight_decay=2.4355336772015963e-06)
    criterion_gnn_simple_framework_without_front_flex_only_degree = torch.nn.CrossEntropyLoss(ignore_index=-1)
    ...
    train_loader_gnn_model_complex_framework_without_front_flex_only_degree = NeighborLoader(
        data_only_degree,
        shuffle=True,
        num_neighbors=[15, 30],
        batch_size=64,
    ...
    val_loader_gnn_model_complex_framework_without_front_flex_only_degree = NeighborLoader(
        data_only_degree,
        shuffle=True,
        num_neighbors=[15, 30],
        batch_size=64,
    ...
    test_loader_gnn_model_complex_framework_without_front_flex_only_degree = NeighborLoader(
        data_only_degree,
        shuffle=True,
        num_neighbors=[15, 30],
        batch_size=64,
    ...
    gnn_model_downstream_framework_without_flipping_layer_only_degree = GraphSAGE(
        ...
        num_layers=3,
        out_channels=2,
        dropout=0.3657989133392912,
        act='leaky_relu',
        aggr='mean'
    )

    gnn_model_complex_framework_without_front_flex_only_degree = DGIPlusGNN(dgi_model_without_flipping_layer_only_degree,
                                                                gnn_model_downstream_framework_without_flipping_layer_only_degree,
                                                                False)
    optimizer_gnn_complex_framework_without_front_flex_only_degree = torch.optim.Adam(
        gnn_model_complex_framework_without_front_flex_only_degree.parameters(),
        lr=0.0018728348199496282, weight_decay=5.645145336662159e-05)
    criterion_gnn_complex_framework_without_front_flex_only_degree = torch.nn.CrossEntropyLoss(ignore_index=-1)
    ...
    optimizer_gnn_simple_gat = torch.optim.Adam(gnn_model_simple_graphsage.parameters(), lr=0.0055020332510524006, weight_decay=3.377923626414446e-05)
    ...
    model_dict = {
        ...
        'simple_framework_without_flex_fronts_only_degree': {
            'model': gnn_model_simple_framework_without_front_flex_only_degree,
            'optimizer': optimizer_gnn_simple_framework_without_front_flex_only_degree,
            'criterion': criterion_gnn_simple_framework_without_front_flex_only_degree,
            'train_set': train_loader_gnn_model_simple_framework_without_front_flex_only_degree,
            'val_set': val_loader_gnn_model_simple_framework_without_front_flex_only_degree,
            'test_set': test_loader_gnn_model_simple_framework_without_front_flex_only_degree
        },
        ...
        'complex_framework_without_flex_fronts_only_degree': {
            'model': gnn_model_complex_framework_without_front_flex_only_degree,
            'optimizer': optimizer_gnn_complex_framework_without_front_flex_only_degree,
            'criterion': criterion_gnn_complex_framework_without_front_flex_only_degree,
            'train_set': train_loader_gnn_model_complex_framework_without_front_flex_only_degree,
            'val_set': val_loader_gnn_model_complex_framework_without_front_flex_only_degree,
            'test_set': test_loader_gnn_model_complex_framework_without_front_flex_only_degree
        },
